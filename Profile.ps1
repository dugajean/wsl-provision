...
function dockrFunc { & vendor/bin/dockr $args }
...
New-Alias -Name phpunit -Value phpunitFunc -Force -Option AllScope
New-Alias -Name artisan -Value artisanFunc -Force -Option AllScope
New-Alias -Name dock -Value dockrFunc -Force -Option AllScope
